...
export function Text({ variant = 'body', className, ...props }: Props) {
  const variantClasses: Record<TextVariant, string> = {
    h1: 'text-[30px] leading-[34px] tracking-[-0.3px] font-bold text-text',
    h2: 'text-[26px] leading-[28px] tracking-[-0.2px] font-semibold text-text',
    h3: 'text-[22px] leading-[24px] font-semibold text-text',
